...
export class CompanyService {
  ...
  companySwitchActive(companyId:any):Observable<any>{
    return this._HttpClient.post(`${environment.baseURL}api/Company/v1/CompanySwitchActive/CompanySwitchActive/${companyId}`, {})
  }
